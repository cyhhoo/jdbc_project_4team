...
<% BookService bookService = new BookService();
    List<BookDTO> recentBooks = new ArrayList<>();
    ...
    <c:choose>
            ...
            <div class="login-container">
                ...
                <form action="${pageContext.request.contextPath}/login" method="post"
                    ...
                    <button type="submit" class="btn-login"
                            style="background-color: #2c3e50; height: 50px; font-size: 1rem;">로그인
                    </button>
                    <div
        ...
        <c:otherwise>
            ...
            <% com.ohgiraffers.service.RecommendationService recService = new
                    com.ohgiraffers.service.RecommendationService();
                com.ohgiraffers.dto.BookDTO
            ...
            <div class="menu-grid">
                ...
                <c:if test="${sessionScope.loginUser.role eq 'ADMIN'}">
                    ...
                    <a href="/book/delete" class="menu-card admin-card">
